$(document).ready(function(){
    ...
    //         $(".left-button").on("click", function(){ //left arrow key
    ...
    //             }
    //         });
    //         $(".up-button").on("click", function(){ //up arrow key
    ...
    //             }
    //         });
    //         $(".right-button").on("click", function(){//right arrow key
    ...
    //             }
    //         });
    //         $(".down-button").on("click", function(){ //bottom arrow key
